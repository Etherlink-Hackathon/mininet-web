      ...
      '/privy-proxy': {
        ...
        configure: (proxy, options) => {
          proxy.on('proxyReq', (proxyReq, req, res) => {
            ...
            proxyReq.setHeader('Origin', 'https://meshpay.up.railway.app');
            proxyReq.setHeader('Referer', 'https://meshpay.up.railway.app');
          ...
          proxy.on('proxyRes', (proxyRes, req, res) => {
            ...
            proxyRes.headers['Access-Control-Allow-Origin'] = 'https://meshpay.up.railway.app';
          ...
          proxy.on('error', (err, req, res) => {
            ...
            if (!res.headersSent) {
              res.writeHead(500, {
                ...
                'Access-Control-Allow-Origin': 'https://meshpay.up.railway.app',
